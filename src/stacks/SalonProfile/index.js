...
import {UserPostsRoute, UserHairfolioRoute, UserAboutRoute, UserStylistsRoute} from '../../routes';

export default class SalonProfileStack extends PureComponent {
  static propTypes = {
    ...
    return (
      <View style={{
        ...
        <Navigator
          ...
          navigationBar={<NavigationBar color={COLORS.SALON} />}
