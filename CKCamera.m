...
//
// replace ./node_modules/react-native-camera-kit/ios/lib/ReactNativeCameraKit/CKCamera.m with CKCamera.m
        ...
        [self.stillImageOutput captureStillImageAsynchronouslyFromConnection:connection completionHandler:^( CMSampleBufferRef imageDataSampleBuffer, NSError *error ) {
            if ( imageDataSampleBuffer ) {
                ...
                if (device.position != AVCaptureDevicePositionFront) {
                    ...
                    capturedImage = [UIImage imageWithCGImage:imageRef scale:capturedImage.scale orientation:UIImageOrientationUpMirrored];
                }
