...
import {basicInfoStylist, stylistInfo, stylistEducation, stylistCertificates, stylistPlaceOfWork, stylistProductExperience} from '../../routes';
...
export default class SignupConsumerStack extends PureComponent {
  ...
  render() {
    return (
      ...
      >
        <Navigator
          initialRoute={stylistCertificates/*basicInfoStylist*/}
          initialRouteStack={[
            basicInfoStylist,
            stylistInfo,
            stylistEducation,
