...
export default class AboutCollapsableContainer extends PureComponent {
  static propTypes = {
    ...
    return (<View style={{marginBottom: SCALE.h(4)}}>
      ...
      >
...

        {
          ...
          <Icon2
          color={COLORS.COLLAPSABLE_TEXT_COLOR}
          name={this.state.open ? 'chevron-thin-up' : 'chevron-thin-down'}
          // name={this.state.open ? 'collapsable-line' : 'expand_button'}
          size={this.state.open ? SCALE.h(31) : SCALE.h(31)}
        />
          :
          <Icon
          color={COLORS.COLLAPSABLE_TEXT_COLOR}
