      ...
      <CustomTouchableOpacity
        ...
        onPress={() => {
          ...
          ImagePicker.showImagePicker({
            ...
            showLog("picture hello ==>"+JSON.stringify(response));
            if (response.error)
            ...
            if (response.path) {
              ...
              showLog("oldPictureURI ==>"+JSON.stringify(oldPictureURI));
              this.setState({
                transforming: true,
                pictureURI: response.path
              });
              this.props.transform(response.path, _.pick(response, ['height', 'width']))
                .then(
                  (value) =>{
                    this.setState({
                      value
