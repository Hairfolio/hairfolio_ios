    ...
    if (!store.isLoading) {
      ...
      content = (
        <View style={{backgroundColor:COLORS.WHITE}}>
          ...
          <View style={{ flexDirection: "row", backgroundColor:COLORS.WHITE, width:windowWidth}}>
            <View style={{width:windowWidth/3}}>
              <CollapsableContainer 
                ...
                onPress={() => {this.setState({isCategoryOpen: !this.state.isCategoryOpen, isSubCategoryOpen: false, isBrandOpen: false})}}
            ...
            <View style={{width:windowWidth/3}}>
              <CollapsableContainer 
                ...
                {
                  <View style={{ flexDirection: "row", width:(windowWidth), flexWrap: "wrap", position:'absolute', zIndex:999999, backgroundColor:COLORS.WHITE, marginLeft: (-(windowWidth)/3)}}>
                    {(store.productSubCategories && store.productSubCategories.length > 0)?
                      ...
                      : 
                        <View style={{justifyContent:'center', flex:1, alignItems:'center', padding:15}}>
          ...
          <View style={{backgroundColor:'blue', position:'absolute', zIndex:-999999, height:windowHeight - 200, width:windowWidth, marginTop:90}}>

            {/* <ScrollView>
              <View style={{ flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between', position:'absolute', zIndex:-999999, backgroundColor:'red'}}>
            ...
            <ScrollView>
            <View style={{ flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between', position:'absolute', zIndex:-999999, backgroundColor:'red', minHeight:windowHeight - 200}}>
            {store.productListSelector.data.map((item, index) => {
                  return (<CatalogResultItem key={item.key}
                    item={item}
                    navigator={this.props.navigator} />)
