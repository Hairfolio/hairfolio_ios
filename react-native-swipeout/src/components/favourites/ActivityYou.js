...
export default class ActivityFollowing extends Component {  
        ...
        <View style={{height:(windowHeight/2)}}>
          ...
          renderFooter={
            () => {
              ...
              // if (store.nextPage != null && store.isLoadingNextPage == true) {
  ...
  //       });
  //     }
  //     showLog("DATA SOURCE ==>" + JSON.stringify(this.state.dataSource));
  //     showLog("NEXT PAGE ==>" + this.state.nextPage);
  //   }
  // }

  // onNavigatorEvent(event) {
  //   showLog("onNavigatorEvent You ==> " + event.id)
  ...
  //         renderFooter={
  //           () => {
  //             if (this.state.nextPage != null && !this.state.isLoadingNextPage) {
  //               return (
  //                 <View style={{flex: 1, paddingVertical: 20, alignItems: 'center', justifyContent: 'center'}}>
  //                   <ActivityIndicator size='large' />
  //                 </View>
