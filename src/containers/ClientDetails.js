        ...
        <View style={{ flex: 1 }}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <Animated.View
              ...
              {
                (this.state.noteCardHeight > 0)
                ?

                <View
                style={{
                  height: (this.state.noteCardHeight > 0) ? (windowHeight - this.state.noteCardHeight) : 0,
                  // width: windowWidth
                }}
              >
                    ...
                    <Animated.View
                      ...
                      style={[styles.card, translateStyle, {
                        ...
                        marginTop: (card.expand == false) ?
                          ...
                          (i == 0) ?  ((store.addressStreet1 + store.addressCity + store.addressState + store.addressPostCode).length > 15) ? (windowHeight / 10) : (windowHeight / 8) : -(windowHeight / 2),
                  ...
                  <View>
                    ...
                    <Animated.View
                      ...
                      style={[styles.card, translateStyle,
                      {
                        ...
                        backgroundColor: card.color,
                        marginTop:
                          (windowHeight < 570) //iPhone5s
                            ?
                            (card.expand == false)
                              ?
                              (i == 0) ? 0 : ((store.addressStreet1 + store.addressCity + store.addressState + store.addressPostCode).length > 15) ? -(windowHeight / 2.34) : -(windowHeight / 2.50)
                              :
                              (i == 0) ? ((store.addressStreet1 + store.addressCity + store.addressState + store.addressPostCode).length > 15) ? (windowHeight / 7) : (windowHeight / 6) : -(windowHeight / 1.7)
                            :
                            (windowHeight < 668) // iPhone6, 6s , 7, 8
                              ?
                              (card.expand == false)
                                ?
                                (i == 0) ? 0 : ((store.addressStreet1 + store.addressCity + store.addressState + store.addressPostCode).length > 15) ? -(windowHeight / 2.90) : -(windowHeight / 4)
                                :
                                (i == 0) ? ((store.addressStreet1 + store.addressCity + store.addressState + store.addressPostCode).length > 15) ? (windowHeight /19) : (windowHeight / 17) : -(windowHeight / 1.7)
                              :
                              (windowHeight < 737) // iPhone7+, 8+
                                ?
                                (card.expand == false)
                                  ?
                                  (i == 0) ? 0 : -(windowHeight / 5)
                                  :
                                  (i == 0) ? ((store.addressStreet1 + store.addressCity + store.addressState + store.addressPostCode).length > 15) ? (windowHeight / 180) : (windowHeight / 38) : -(windowHeight / 1.7) // windowHeight / 250 : -(windowHeight / 1.5)
                                :
                                (card.expand == false)
                                  ?
